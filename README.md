...
<img src='SimpleTweet (1).gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [AZ Screen Recorder].

## Notes

Tweets would not properly display despite screen name and profile picture displaying. I was denied Twitter API access.
